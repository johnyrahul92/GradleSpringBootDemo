...
public class SwaggerConfiguration {
	...
	public ApiInfo apiInfo() {	
		...
		builder.title("CUSTOMER ON BOARD API through Swagger UI").version("1.0").license("(C) Copyright Test")
				.description("List of all the APIs of CUSTOMER ON BOARD App through Swagger UI");
